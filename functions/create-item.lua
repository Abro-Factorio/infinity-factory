function create_item_with_level(exmaple_name, prefix_name, level)
    return create_item_with_level(exmaple_name, prefix_name, level, Consts.EMPTY_FUNCTION)
end

function create_item_with_level(exmaple_name, prefix_name, level, item_updater)
    validate_level(level)
    local new_name = get_name_by_level(prefix_name, level)
    local zero_item = data.raw["item"][exmaple_name]
